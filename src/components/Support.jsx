...
const Support = ({ mode }) => {
  ...
  const containerVariants = {
    ...
    visible: {
      transition: {
        staggerChildren: 0.3, // Adjust stagger delay if needed
      },
    },
  };

  // Each child will animate from an opacity of 0 and y offset to its natural position
  const childVariants = {
    ...
    >
      <div className="container max-w-[1240px]">
        ...
        >
          ...
          >
            ...
            >
              <div className="flex flex-col items-center">
                <h3 className="text-2xl font-semibold text-center">Fast Support</h3>
                <p
          ...
          >
            <Eyebrow text="Support" theme={mode === "dark" ? "white" : "light"} />
            <h2
