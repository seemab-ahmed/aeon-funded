  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <img src={Texture} alt="texture" loading="lazy" className={`w-full h-full ${mode==='dark'?'':'filter invert grayscale'}`} />
      </div>
      <div className="absolute inset-0 w-full h-full">
      <img src={BannerGradient} alt="BannerGradient" loading="lazy" className={`w-full h-full object-cover object-bottom ${mode==='dark'?'':'opacity-0'}`} />
      </div>
    </section>
  );
};
